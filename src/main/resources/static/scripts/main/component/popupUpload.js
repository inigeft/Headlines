            ...
            '<div>',
              '<div class="form-group">',
                '<div class="form-group">',
                    ...
                    '</div>',
                '</div>',
                  '<div class="form-group"><label class="col-sm-2 control-label">标题</label><div class="col-sm-10"><input class="js-title form-control" type="text" placeholder="一句话分享心情"></div></div>',
                  '<div class="form-group"><label class="col-sm-2 control-label">转载自</label><div class="col-sm-10"><input class="js-link form-control" type="text" placeholder="填写原新闻链接（可选）"></div></div>',
                  '<div class="form-group">',
